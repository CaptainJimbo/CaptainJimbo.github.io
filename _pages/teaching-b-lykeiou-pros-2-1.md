---
layout: page
permalink: /teaching/b-lykeiou-pros/2-1/
title: "2.1 Η έννοια του συστήματος"
nav: false
---
...
<div class="subnav">
<a class="sn-prev" href="{{ '/teaching/b-lykeiou-pros/syn-1/' | relative_url }}"><span class="sn-lbl">Προηγούμενη ενότητα</span><span class="sn-name">Συνδυαστικές Ασκήσεις Τράπεζας Θεμάτων</span></a>
<a class="sn-all" href="{{ '/teaching/b-lykeiou-pros/' | relative_url }}">Όλα τα κεφάλαια</a>
<a class="sn-next" href="{{ '/teaching/b-lykeiou-pros/2-2/' | relative_url }}"><span class="sn-lbl">Επόμενη ενότητα</span><span class="sn-name">2.2 Το φαινόμενο της κρούσης</span></a>
</div>

<p style="margin:0 0 1.1rem;"><a href="https://ebooks.edu.gr/ebooks/v/html/8547/2684/Fysiki_B-Lykeiou-ThSp_html-empl/index2_1.html" target="_blank" rel="noopener" style="color:var(--global-theme-color);"><i class="fa-solid fa-book"></i>&nbsp;Δες την ενότητα «2.1 Η έννοια του συστήματος» στο Βιβλίο μαθητή</a></p>

<h5 class="sec-title">Σημειώσεις</h5>
<div class="notes-box" markdown="1">

- **Σύστημα:** «ένα **σύνολο δύο ή περισσοτέρων σωμάτων που αλληλεπιδρούν**» αποτελούν σύστημα στη Φυσική. Εμείς **επιλέγουμε** ποια σώματα θα θεωρήσουμε «μέσα» στο σύστημα.
- **Εσωτερικές δυνάμεις:** «αυτές που προέρχονται **αποκλειστικά από τα σώματα που αποτελούν το σύστημα**» (δηλαδή ασκούνται μεταξύ των μελών του συστήματος).
- **Εξωτερικές δυνάμεις:** «δυνάμεις που προέρχονται από **άλλα σώματα**», εκτός συστήματος.
- **Μονωμένο σύστημα:** «σύστημα στο οποίο **δεν ασκούνται εξωτερικές δυνάμεις** ή αν ασκούνται έχουν **μηδενική συνισταμένη**». Αυτή είναι η προϋπόθεση για να ισχύει η αρχή διατήρησης της ορμής (ενότητα 2.5).
- Οι **εσωτερικές** δυνάμεις εμφανίζονται πάντα σε **ζεύγη δράσης–αντίδρασης** μέσα στο σύστημα, οπότε η συνολική τους συνεισφορά αλληλοαναιρείται.
</div>

<h5 class="sec-title">Ασκήσεις στην Ενότητα 2.1 — Η έννοια του συστήματος</h5>
...
<br>**α)** η δύναμη που ασκεί η πρώτη μπάλα στη δεύτερη
<br>**β)** το βάρος κάθε μπάλας
<br>**γ)** η κάθετη δύναμη από το τραπέζι

<details class="qa" markdown="1">
<summary>Λύση</summary>

<p markdown="1">**α) Εσωτερική** — προέρχεται από σώμα που ανήκει στο σύστημα.</p>
<p markdown="1">**β) Εξωτερική** — προέρχεται από τη Γη, που είναι εκτός συστήματος.</p>
<p markdown="1">**γ) Εξωτερική** — προέρχεται από το τραπέζι, εκτός συστήματος.</p>
...
<p markdown="1">**Ναι.** Οι εξωτερικές δυνάμεις (βάρος και κάθετη δύναμη) είναι **κατακόρυφες** και έχουν **μηδενική συνισταμένη** (αλληλοαναιρούνται). Στην **οριζόντια** διεύθυνση, όπου γίνεται η κρούση, δεν ασκείται εξωτερική δύναμη (το τραπέζι είναι λείο). Άρα το σύστημα συμπεριφέρεται ως **μονωμένο** οριζόντια και η ορμή διατηρείται.</p>
...
<p markdown="1">Όταν **δεν ασκούνται εξωτερικές δυνάμεις**, ή όταν αυτές που ασκούνται έχουν **μηδενική συνισταμένη**. Δεν χρειάζεται δηλαδή να λείπουν εντελώς οι εξωτερικές δυνάμεις — αρκεί να αλληλοαναιρούνται.</p>
