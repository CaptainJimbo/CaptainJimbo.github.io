---
layout: page
permalink: /teaching/b-lykeiou-pros/5-6/
title: "5.6 Δυναμική ενέργεια πολλών φορτίων"
nav: false
---
...
<div class="subnav">
<a class="sn-prev" href="{{ '/teaching/b-lykeiou-pros/5-5/' | relative_url }}"><span class="sn-lbl">Προηγούμενη ενότητα</span><span class="sn-name">5.5 Δυναμικό — διαφορά δυναμικού</span></a>
<a class="sn-all" href="{{ '/teaching/b-lykeiou-pros/' | relative_url }}">Όλα τα κεφάλαια</a>
<a class="sn-next" href="{{ '/teaching/b-lykeiou-pros/5-7/' | relative_url }}"><span class="sn-lbl">Επόμενη ενότητα</span><span class="sn-name">5.7 Σχέση έντασης & διαφοράς δυναμικού</span></a>
</div>

<p style="margin:0 0 1.1rem;"><a href="https://ebooks.edu.gr/ebooks/v/html/8547/2684/Fysiki_B-Lykeiou-ThSp_html-empl/index5_6.html" target="_blank" rel="noopener" style="color:var(--global-theme-color);"><i class="fa-solid fa-book"></i>&nbsp;Δες την ενότητα «5.6 Δυναμική ενέργεια πολλών φορτίων» στο Βιβλίο μαθητή</a></p>

<h5 class="sec-title">Σημειώσεις</h5>
<div class="notes-box" markdown="1">

- Για **δύο** σημειακά φορτία σε απόσταση $r$: <span class="frm">$$U = k_c\dfrac{q_1 q_2}{r}$$</span> (τα φορτία **με τα πρόσημά** τους: ομώνυμα → $U>0$, ετερώνυμα → $U<0$).<br>Για **πολλά** φορτία, η συνολική δυναμική ενέργεια είναι το **άθροισμα των δυναμικών ενεργειών όλων των ζευγών**. Π.χ. για τρία φορτία με αποστάσεις $\alpha, \beta, \gamma$ ανά ζεύγος: <span class="frm">$$U = k_c\left(\dfrac{q_1q_2}{\gamma} + \dfrac{q_1q_3}{\beta} + \dfrac{q_2q_3}{\alpha}\right)$$</span>
- **Προσοχή:** «Η δυναμική ενέργεια ανήκει στο **σύστημα** των φορτίων συνολικά και **δεν μπορεί να αποδοθεί σε κάποιο μεμονωμένο φορτίο**».
- **Μέθοδος:** μετράμε **κάθε ζεύγος μία φορά**. Για $n$ φορτία υπάρχουν $\dfrac{n(n-1)}{2}$ ζεύγη — για 3 φορτία, 3 ζεύγη· για 4 φορτία, 6 ζεύγη.
</div>

<h5 class="sec-title">Τυπολόγιο</h5>
<div class="typ-box" markdown="1">

$$U_{ζεύγους} = k_c\dfrac{q_1q_2}{r}$$

$$U_{ολ} = \sum_{ζεύγη} k_c\dfrac{q_i q_j}{r_{ij}}$$

$$\text{πλήθος ζευγών} = \dfrac{n(n-1)}{2}$$
</div>

<h5 class="sec-title">Ασκήσεις στην Ενότητα 5.6 — Δυναμική ενέργεια πολλών φορτίων</h5>
...
$$U = k_c\dfrac{q_1q_2}{r} = 9\cdot10^{9}\cdot\dfrac{(3\cdot10^{-6})(-2\cdot10^{-6})}{0{,}9} = -6\cdot10^{-2}\ \text{J}$$

<p markdown="1">Αρνητική, γιατί τα φορτία είναι **ετερώνυμα** (έλκονται).</p>
...
$$\dfrac{n(n-1)}{2} = \dfrac{4\cdot3}{2} = 6 \text{ ζεύγη}$$

<p markdown="1">Κάθε ζεύγος μετριέται **μία μόνο φορά** — το ζεύγος (1,2) είναι το ίδιο με το (2,1).</p>
...
<p markdown="1">Γιατί προκύπτει από την **αλληλεπίδραση** μεταξύ φορτίων: χωρίς το δεύτερο φορτίο δεν θα υπήρχε δύναμη, άρα ούτε δυναμική ενέργεια. Δεν έχει νόημα να πούμε «αυτό το φορτίο έχει $U$» — η ενέργεια ανήκει στη **διάταξη** των φορτίων συνολικά.</p>
