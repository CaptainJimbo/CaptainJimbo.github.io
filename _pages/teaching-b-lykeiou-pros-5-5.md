---
layout: page
permalink: /teaching/b-lykeiou-pros/5-5/
title: "5.5 Δυναμικό — διαφορά δυναμικού"
nav: false
---
...
<div class="subnav">
<a class="sn-prev" href="{{ '/teaching/b-lykeiou-pros/5-4/' | relative_url }}"><span class="sn-lbl">Προηγούμενη ενότητα</span><span class="sn-name">5.4 Ο νόμος του Gauss</span></a>
<a class="sn-all" href="{{ '/teaching/b-lykeiou-pros/' | relative_url }}">Όλα τα κεφάλαια</a>
<a class="sn-next" href="{{ '/teaching/b-lykeiou-pros/5-6/' | relative_url }}"><span class="sn-lbl">Επόμενη ενότητα</span><span class="sn-name">5.6 Δυναμική ενέργεια πολλών φορτίων</span></a>
</div>

<p style="margin:0 0 1.1rem;"><a href="https://ebooks.edu.gr/ebooks/v/html/8547/2684/Fysiki_B-Lykeiou-ThSp_html-empl/index5_5.html" target="_blank" rel="noopener" style="color:var(--global-theme-color);"><i class="fa-solid fa-book"></i>&nbsp;Δες την ενότητα «5.5 Δυναμικό — διαφορά δυναμικού» στο Βιβλίο μαθητή</a></p>

<h5 class="sec-title">Σημειώσεις</h5>
<div class="notes-box" markdown="1">

- **Δυναμικό:** «Ονομάζουμε **δυναμικό** του ηλεκτρικού πεδίου σε ένα σημείο του Α το **σταθερό πηλίκο του έργου** της δύναμης που ασκεί το πεδίο σε φορτίο $q$, κατά τη **μετακίνηση του φορτίου από το Α στο άπειρο**, **προς το φορτίο** που μετακινείται»: <span class="frm">$$V_A = \dfrac{W_{A\to\infty}}{q}$$</span> Για **σημειακό φορτίο**: <span class="frm">$$V = k_c\dfrac{Q}{r}$$</span> (με το **πρόσημο** του $Q$). Μονάδα: $1\ \text{V} = 1\ \text{J/C}$.
- **Διαφορά δυναμικού:** «Η διαφορά δυναμικού $V_A - V_B$ ανάμεσα σε δύο σημεία Α και Β του ηλεκτρικού πεδίου είναι ίση με το **πηλίκο του έργου** που παράγει ή καταναλώνει η δύναμη του πεδίου κατά τη **μετακίνηση ενός φορτίου $q$ από το Α στο Β** προς το φορτίο $q$»: <span class="frm">$$V_A - V_B = \dfrac{W_{A\to B}}{q}$$</span>
- Το δυναμικό είναι **μονόμετρο** — τα δυναμικά από πολλά φορτία προστίθενται **αλγεβρικά**.
</div>
...
<h5 class="sec-title">Ασκήσεις στην Ενότητα 5.5 — Δυναμικό</h5>
...
<p markdown="1">Το φορτίο μπαίνει **με το πρόσημό** του:</p>

$$V = k_c\dfrac{Q}{r} = 9\cdot10^{9}\cdot\dfrac{-2\cdot10^{-6}}{0{,}6} = -3\cdot10^{4}\ \text{V}$$

<p markdown="1">Αρνητικό, όπως περιμέναμε για αρνητικό φορτίο.</p>

</details>

**Άσκηση 2.** Μεταφέρουμε φορτίο $q = 5\ \mu\text{C}$ από σημείο Α σε σημείο Β, όπου $V_A - V_B = 400\ \text{V}$. Πόσο έργο παράγει η δύναμη του πεδίου;

<details class="qa" markdown="1">
<summary>Λύση</summary>

<p markdown="1">Από τον ορισμό της διαφοράς δυναμικού:</p>

$$W_{A\to B} = q(V_A - V_B) = 5\cdot10^{-6}\cdot400 = 2\cdot10^{-3}\ \text{J}$$

</details>

**Άσκηση 3.** Σε σημείο Μ δύο φορτία δημιουργούν δυναμικά $+400\ \text{V}$ και $-100\ \text{V}$. Πόσο είναι το ολικό δυναμικό;

<details class="qa" markdown="1">
<summary>Λύση</summary>

<p markdown="1">Το δυναμικό είναι **μονόμετρο**, άρα προστίθεται **αλγεβρικά**:</p>

$$V_M = 400 + (-100) = 300\ \text{V}$$

<p markdown="1">(Αν ζητούσαμε την **ένταση**, θα έπρεπε **διανυσματική** πρόσθεση.)</p>
