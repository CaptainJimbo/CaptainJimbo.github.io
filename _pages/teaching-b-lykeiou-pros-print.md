---
layout: page
permalink: /teaching/b-lykeiou-pros/print/
...
<p id="back-link" style="margin:0 0 1rem;"><a href="{{ '/teaching/b-lykeiou-pros/' | relative_url }}" style="color:var(--global-theme-color);">&larr; Πίσω στα κεφάλαια</a></p>

<div id="sheet-status">Συγκέντρωση ασκήσεων…</div>
<div id="sheet"></div>
<div class="sheet-footer">Φυσική Β΄ Λυκείου Προσανατολισμού — captainjimbo.github.io/teaching/b-lykeiou-pros/ · Λύσεις: βήμα-βήμα στις αντίστοιχες ενότητες του site.</div>

<script>
(function () {
  var BASE = '/teaching/b-lykeiou-pros/';
  var CH = {
    '1': { name: 'Κεφάλαιο 1 · Καμπυλόγραμμες κινήσεις',
           pages: ['1-1','1-2','1-3','1-4','book-1','syn-1'] },
    '2': { name: 'Κεφάλαιο 2 · Διατήρηση της ορμής',
           pages: ['2-1','2-2','2-3','2-4','2-5','2-6','2-7','book-2','syn-2'] },
    '3': { name: 'Κεφάλαιο 3 · Κινητική θεωρία των αερίων',
           pages: ['3-1','3-2','3-3','3-4','3-5','3-6','3-7','book-3','syn-3'] },
    '4': { name: 'Κεφάλαιο 4 · Θερμοδυναμική',
           pages: ['4-1','4-2','4-3','4-4','4-5','4-6','4-7','4-8','4-9','4-10','4-11','4-12','4-13','4-14','4-15','book-4','syn-4'] },
    '5': { name: 'Κεφάλαιο 5 · Ηλεκτρικό & βαρυτικό πεδίο',
           pages: ['5-1','5-2','5-3','5-4','5-5','5-6','5-7','5-8','5-9','5-10','5-11','5-12','5-13','5-14','5-15','book-5'] },
    'prep': { name: 'Μικτές ασκήσεις — όλη η ύλη', pages: ['mikta'] }
  };
