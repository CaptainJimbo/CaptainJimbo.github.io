---
layout: page
permalink: /teaching/a-lykeiou/print/
...
<p id="back-link" style="margin:0 0 1rem;"><a href="{{ '/teaching/a-lykeiou/' | relative_url }}" style="color:var(--global-theme-color);">&larr; Πίσω στα κεφάλαια</a></p>

<div id="sheet-status">Συγκέντρωση ασκήσεων…</div>
<div id="sheet"></div>
<div class="sheet-footer">Φυσική Α΄ Λυκείου — captainjimbo.github.io/teaching/a-lykeiou/ · Λύσεις: βήμα-βήμα στις αντίστοιχες ενότητες του site.</div>

<script>
(function () {
  var BASE = '/teaching/a-lykeiou/';
  var CH = {
    '1': { name: 'Κεφάλαιο 1 · Κινήσεις & Δυναμική', pages: ['1-1','1-2','1-3','syn-1'] },
    '2': { name: 'Κεφάλαιο 2 · Ενέργεια', pages: ['2-1','2-2'] },
