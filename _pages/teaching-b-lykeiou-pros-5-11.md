---
layout: page
permalink: /teaching/b-lykeiou-pros/5-11/
title: "5.11 Πυκνωτές και διηλεκτρικά"
nav: false
---
...
<div class="subnav">
<a class="sn-prev" href="{{ '/teaching/b-lykeiou-pros/5-10/' | relative_url }}"><span class="sn-lbl">Προηγούμενη ενότητα</span><span class="sn-name">5.10 Ενέργεια φορτισμένου πυκνωτή</span></a>
<a class="sn-all" href="{{ '/teaching/b-lykeiou-pros/' | relative_url }}">Όλα τα κεφάλαια</a>
<a class="sn-next" href="{{ '/teaching/b-lykeiou-pros/5-12/' | relative_url }}"><span class="sn-lbl">Επόμενη ενότητα</span><span class="sn-name">5.12 Το βαρυτικό πεδίο</span></a>
</div>

<p style="margin:0 0 1.1rem;"><a href="https://ebooks.edu.gr/ebooks/v/html/8547/2684/Fysiki_B-Lykeiou-ThSp_html-empl/index5_11.html" target="_blank" rel="noopener" style="color:var(--global-theme-color);"><i class="fa-solid fa-book"></i>&nbsp;Δες την ενότητα «5.11 Πυκνωτές και διηλεκτρικά» στο Βιβλίο μαθητή</a></p>

<h5 class="sec-title">Σημειώσεις</h5>
<div class="notes-box" markdown="1">

- **Διηλεκτρικά:** «**Διηλεκτρικά ή μονωτές** ονομάζονται τα υλικά όπως το **λάδι, το γυαλί, το λαδόχαρτο** κ.ά., που **δεν επιτρέπουν την κίνηση ηλεκτρικών φορτίων**». Χρησιμοποιούνται στους περισσότερους πυκνωτές ανάμεσα στους οπλισμούς.
- **Διηλεκτρική σταθερά $K$:** ορίζεται ως <span class="frm">$$K = \dfrac{C}{C_0}$$</span> όπου $C$ η χωρητικότητα **με** διηλεκτρικό και $C_0$ **χωρίς**. «Η διηλεκτρική σταθερά $K$ είναι **καθαρός αριθμός, μεγαλύτερος της μονάδας** και **χαρακτηρίζει το υλικό**». Άρα η χωρητικότητα **αυξάνεται**: <span class="frm">$$C = K\,C_0 = K\dfrac{\varepsilon_0 A}{d}$$</span>
- **Γιατί αυξάνεται:** λόγω της **πόλωσης** του διηλεκτρικού — «τα δίπολα αυτά **προσανατολίζονται** όταν βρεθούν στο ομογενές ηλεκτρικό πεδίο», δημιουργώντας **επαγόμενα φορτία** που **ελαττώνουν** το συνολικό πεδίο (άρα και την τάση), οπότε για το ίδιο φορτίο προκύπτει **μεγαλύτερη** χωρητικότητα.
</div>

<h5 class="sec-title">Τυπολόγιο</h5>
<div class="typ-box" markdown="1">

$$K = \dfrac{C}{C_0} > 1 \qquad C = K\,C_0 = K\dfrac{\varepsilon_0 A}{d}$$
</div>

<h5 class="sec-title">Ασκήσεις στην Ενότητα 5.11 — Διηλεκτρικά</h5>
...
<p markdown="1">Γιατί το διηλεκτρικό **πάντα αυξάνει** τη χωρητικότητα. Τα μόριά του **πολώνονται** και προσανατολίζονται στο πεδίο, δημιουργώντας **επαγόμενα φορτία** που **ελαττώνουν** το συνολικό πεδίο (άρα και την τάση $V$). Με μικρότερη $V$ για το ίδιο $Q$, το πηλίκο $C = Q/V$ **μεγαλώνει** — άρα $K = C/C_0 > 1$.</p>
...
<p markdown="1">**Λάδι, γυαλί, λαδόχαρτο** (και πλαστικά, μαρμαρυγίας κ.ά.). Κοινό τους: **δεν επιτρέπουν την κίνηση ηλεκτρικών φορτίων** — είναι δηλαδή **μονωτές**, γι' αυτό μπορούν να μπουν ανάμεσα στους οπλισμούς χωρίς να τους βραχυκυκλώσουν.</p>
